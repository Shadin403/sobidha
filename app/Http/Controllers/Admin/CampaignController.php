...
class CampaignController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->except(['files', 'product_ids']);
        // image one
        ...
        if ($request->product_ids) {
            Product::whereIn('id', $request->product_ids)->update(['campaign_id' => $campaign->id]);
        }
    ...
    public function update(Request $request)
    {
        ...
        // Update Products
        Product::where('campaign_id', $update_data->id)->update(['campaign_id' => null]);
        if ($request->product_ids) {
            Product::whereIn('id', $request->product_ids)->update(['campaign_id' => $update_data->id]);
        }
