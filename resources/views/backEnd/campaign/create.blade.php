    ...
    @enderror-->
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('image_three') is-invalid @enderror "
                                        name="image_three" value="{{ old('image_three') }}" id="image_three">
                                    @error('image_three')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('image_one') is-invalid @enderror "
                                        name="image_one" value="{{ old('image_one') }}" id="image_one" required="">
                                    @error('image_one')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 my-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="features" rows="6" class="summernote form-control @error('features') is-invalid @enderror"></textarea>
                                    @error('features')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 my-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="included_items" rows="6"
                                        class="summernote form-control @error('included_items') is-invalid @enderror"></textarea>
