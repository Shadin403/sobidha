...
@section('content')
    ...
    @enderror-->
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    <label for="image_three" class="form-label">Banner Image </label>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <div class="form-group">
                                    <label for="image_two" class="form-label">Image Three</label>
                                    <input type="file" class="form-control @error('image_three') is-invalid @enderror"
                                        name="image_three" value="{{ $edit_data->image_three }}" id="image_three">
                                    <img src="{{ asset($edit_data->image_three) }}" alt="" class="edit-image">
                                    @error('image_three')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('review') is-invalid @enderror"
                                        name="review" value="{{ $edit_data->review }}" id="review" required="">
                                    @error('review')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="features" rows="6" class="summernote form-control @error('features') is-invalid @enderror">{{ $edit_data->features }}</textarea>
                                    @error('features')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="included_items" rows="6"
                                        class="summernote form-control @error('included_items') is-invalid @enderror">{{ $edit_data->included_items }}</textarea>
