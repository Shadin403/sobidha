                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="action2-btn">
                            ...
                            @endif
                            <li><a data-bs-toggle="modal" data-bs-target="#pathao" class="btn rounded-pill btn-info pathao_select"><i class="fe-truck"></i> pathao</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4">
...
$(document).ready(function(){
    ...
    $(document).on('click', '.multi_order_courier', function(e){
        ...
        // pathao courier
    $(document).on('click', '.pathao_select', function(e){
        e.preventDefault();
       ...
       // Send the selected order IDs to the Pathao form
    $('#order_sendto_pathao').find('input[name="order_ids"]').remove(); 

    // Create a hidden input field 
    $('#order_sendto_pathao').append('<input type="hidden" name="order_ids" value="' + order_ids.join(',') + '">');
