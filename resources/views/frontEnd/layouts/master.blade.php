...
})(window,document,'script','dataLayer','GTM-TTX3FRHZ');</script>
 ...
 if (x.style.display === "none") {
    ...
    x.style.display = "none";
      ...
      <footer>
                            ...
                            <div class="footer-menu">
                                <ul>
                                    <li class="title"><a>Contact Us</a></li>
                                     ...
                                     <li class="">
                                               <a href="tel:{{$contact->hotline}}" class="footer-hotlint ">Email: {{$contact->email}}</a>
                                    </li>
                                     <li class="">
                                             <a href="tel:{{$contact->hotline}}" class="footer-hotlint ">Phone: {{$contact->hotline}}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2 mb-3 mb-sm-0 col-12">
                            <div class="footer-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('contact')}}"> <a href="{{route('contact')}}">Contact</a></a>
                                    </li>
        ...
        <div class="footer_nav">
            <ul>
                ...
                <li class="mobile_home">
                    ...
                    <!--</a>-->
                    <a href="https://sobidha.com/hot-deals"><img src="https://i.ibb.co/xK2YVHJZ/IMG-20250531-WA0008-removebg-preview.png" alt="hotdeal"></a>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5F7P2B5D"
