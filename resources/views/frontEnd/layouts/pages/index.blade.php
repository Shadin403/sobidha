...
<meta property="og:image" content="{{ asset($generalsetting->white_logo) ?? null }}" />
...
<section class="homeproduct">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="topcategory topcategory_slider owl-carousel" style="margin-right:-19px ">
                    @foreach ($menucategories as $key => $value)
                        <div class="cat_item bg-white p-2 text-center border-0">
                            <div class="cat_img">
...
<script>
    $(document).ready(function() {
        ...
        $(".topcategory_slider").owlCarousel({
            margin: -19,
            items: 6,
            loop: true,
            dots: false,
